...
from modules.rqvae.rqvae import RqVae
from modules.rqvae.quantize import QuantizeForwardMode, QuantizeDistance
from modules.tokenizer.semids import SemanticIdTokenizer
from modules.utils import parse_config
from modules.scheduler.inv_sqrt import LinearWarmupCosineDecayScheduler
...
def train(
    ...
    vae_codebook_normalize_type='rms',
    ...
    **kwargs
    ...
    print("init accelerator over ...")

    device = accelerator.device

    print("init dataset ...")
    # print(dataset_folder, dataset)
    # raise NotImplementedError("just want to stop")
    ...
    model = RqVae(
        ...
        codebook_normalize_type=vae_codebook_normalize_type,
        codebook_sim_vq=vae_sim_vq,
        codebook_mode=vae_codebook_mode,
        codebook_distance_mode=vae_codebook_distance_mode,
    ...
    tokenizer = SemanticIdTokenizer(
        ...
        rqvae_codebook_normalize_type=vae_codebook_normalize_type,
        rqvae_sim_vq=vae_sim_vq,
    )
    tokenizer.rq_vae = model
    print("init tokenizer over ...")
        ...
        for iter in range(start_iter, start_iter+1+iterations):
            ...
            if accelerator.is_main_process:
                if (iter+1) % save_model_every == 0 or iter+1 == iterations:
                    ...
                    torch.save(model.state_dict(), save_dir_root + f"checkpoint_{iter}.pt")
...
if __name__ == "__main__":
    ...
    train(
        ...
        warmup_steps=args.vae_warmup_steps,
        batch_size=args.vae_batch_size,
        learning_rate=args.vae_learning_rate,
        min_learning_rate=args.vae_min_learning_rate,
        ...
        save_dir_root=args.vae_save_dir_root,
        use_kmeans_init=args.vae_use_kmeans_init,
        ...
        gradient_accumulate_every=args.vae_gradient_accumulate_every,
        save_model_every=args.vae_save_model_every,
        eval_every=args.vae_eval_every,
        commitment_weight=args.vae_commitment_weight,
        ...
        vae_codebook_normalize_type=args.vae_codebook_normalize_type,
        ...
        global_normalize=args.vae_global_normalize,
    )
    end = time.time()
