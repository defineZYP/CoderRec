...
class SemanticIdTokenizer(nn.Module):
    ...
    def __init__(
        ...
        rqvae_codebook_normalize_type: str = "rms",
        rqvae_sim_vq: bool = False,
        rqvae_codebook_mode: QuantizeForwardMode = QuantizeForwardMode.STE,
        rqvae_codebook_distance_mode: QuantizeDistance = QuantizeDistance.L2,
        enable_count_token: bool = True
    ) -> None:
        super().__init__()
        ...
        self.rq_vae = RqVae(
            ...
            codebook_normalize_type=rqvae_codebook_normalize_type,
            codebook_sim_vq=rqvae_sim_vq,
            codebook_mode=rqvae_codebook_mode,
            codebook_distance_mode=rqvae_codebook_distance_mode,
            n_layers=n_layers,
        ...
        self.reset()
        self.enable_count_token = enable_count_token
    ...
    def precompute_corpus_ids(self, movie_dataset: ItemData) -> Tensor:
        ...
        if self.enable_count_token:
            ...
            # print((dedup_dim_tensor.float() >= 1).sum())
            # raise NotImplementedError()
        else:
            self.cached_ids = cached_ids
        self.max_user_ids = max_user_ids
