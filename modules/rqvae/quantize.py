...
from modules.rqvae.distributions.gumbel import gumbel_softmax_sample
from modules.rqvae.init.kmeans import kmeans_init_
from modules.loss import QuantizeLoss
from modules.rqvae.normalize import L2NormalizationLayer
...
class Quantize(nn.Module):
    ...
    def get_embeddings_from_ids(self, item_ids_one_hot):
        emb = self.out_proj(F.linear(item_ids_one_hot, self.embedding.weight.T))
        return emb
